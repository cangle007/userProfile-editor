import getData05 from '../../api/getData05.js';
import dog01 from '../../images/dog01.png';
import dog02 from '../../images/dog02.png';
import dog03 from '../../images/dog03.png';
import dog04 from '../../images/dog04.png';
import doginline from '../../images/doginline.png';

export default function getData05Process() {
  return (dispatch, getState) => {
    return getData05()
      ...
      .then(result => {
        ...
        dispatch({ type: 'GET_DATA_05', data05: result });
      });
  };
}
