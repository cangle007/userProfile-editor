import getData04 from '../../api/getData04.js';
import cat01 from '../../images/cat01.png';
import cat04 from '../../images/cat04.png';
import catinline from '../../images/catinline.png';
import cat06 from '../../images/cat06.png';

export default function getData04Process() {
  return (dispatch, getState) => {
    return getData04()
      ...
      .then(result => {
        ...
        dispatch({ type: 'GET_DATA_04', data04: result });
      });
  };
}
